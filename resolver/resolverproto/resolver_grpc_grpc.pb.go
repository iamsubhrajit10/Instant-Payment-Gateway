...
func (c *detailsClient) UnarryCall(ctx context.Context, in *Clientmsg, opts ...grpc.CallOption) (*Servermsg, error) {
	out := new(Servermsg)
	err := c.cc.Invoke(ctx, "/grpcmsg.Details/UnarryCall", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Details_UnarryCall_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grpcmsg.Details/UnarryCall",
	}
