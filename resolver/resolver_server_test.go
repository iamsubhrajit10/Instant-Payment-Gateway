...
// func BenchmarkProcessGRPCMessageSerial(b *testing.B) {
...
// 			fmt.Sprintf(`{"PaymentID":"%d","AccountNumber":"1234567890%d","IFSCCode":"IFSC000%d","HolderName":"Holder%d"}`, i, i, i, i),
// 		}
// 	}
...
// 	file, err := os.Create("benchmark_stats_serial.txt")
// 	if err != nil {
// 		b.Fatal(err)
// 	}
// 	defer file.Close()
...
func BenchmarkProcessGRPCMessageParallel(b *testing.B) {
	benchmarks := make([]struct {
		name string
		msg  string
	}, 100000)
